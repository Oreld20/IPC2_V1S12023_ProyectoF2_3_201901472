...
class ListaDoblementeEnlazada:
    ...
    def CargarXML_salas(self,operacion):
        if operacion == 1:
            self.primero= None
        tree = ET.parse(r'C:\Users\eliot\OneDrive\Documentos\MyEspacio_De_Trabajo\proyecto-ipc2\salas.XML')
        root = tree.getroot()
        cine = root.find('cine')
    ...
    def editar_sala(self, numero_sala, nuevo_numero, nuevos_asientos):
        ...
        for sala in root.iter('sala'):
            ...
            tree.write(r'C:\Users\eliot\OneDrive\Documentos\MyEspacio_De_Trabajo\proyecto-ipc2\salas.XML')
