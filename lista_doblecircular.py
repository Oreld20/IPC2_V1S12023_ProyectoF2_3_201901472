...
class ListaDoblementeEnlazadaCircular:
    ...
    def CargarXML_Categorias(self):
        ...
        tree = ET.parse(r'C:\Users\eliot\OneDrive\Documentos\MyEspacio_De_Trabajo\proyecto-ipc2\categorias_peliculas.XML')
        root = tree.getroot()
    ...
    def eliminar_pelicula_por_titulo(self, titulo):
        ...
        tree.write(r'C:\Users\eliot\OneDrive\Documentos\MyEspacio_De_Trabajo\proyecto-ipc2\categorias_peliculas.XML')
    ...
    def eliminar_categoria_xml(self, nombre_categoria):
        # Cargar el archivo XML
        tree = ET.parse(r'C:\Users\eliot\OneDrive\Documentos\MyEspacio_De_Trabajo\proyecto-ipc2categorias_peliculas.XML')
        root = tree.getroot()
        ...
        # Guardar los cambios en el archivo XML
        tree.write(r'C:\Users\eliot\OneDrive\Documentos\MyEspacio_De_Trabajo\proyecto-ipc2categorias_peliculas.XML')
